...
import {
  ...
  LayoutGrid, Map, MapPin, Music2, Plus, School, Search, Settings2, Users, UserRound,
  ...
  return <main className="operation-app">
    <aside className="operation-sidebar">
      ...
      <NavGroup label={t.operate} current={view} setView={setView} items={[
        ["calendar", CalendarDays, t.calendar], ["campus", Map, t.campus], ["students", Users, t.students], ["teachers", UserRound, t.teachers],
      ]} />
