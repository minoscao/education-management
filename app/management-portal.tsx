...
type Detail = { kind: "session" | "student" | "teacher" | "room" | "course" | "studentCreate"; id: string; startsAt?: string; edit?: boolean } | null;
...
function CourseDetailContent({ tab, item, lessons, students, openDetail }: { tab: string; item: Row; lessons: Row[]; students: Row[]; openDetail: (detail: Exclude<Detail, null>) => void }) {
  const now = Date.now();
